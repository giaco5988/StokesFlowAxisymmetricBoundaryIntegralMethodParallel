...
RemeshMPI::RemeshMPI(GeometryMPI* geo){
...
void RemeshMPI::SetVelU(double x, int point){

  unew[point] = x;

}

void RemeshMPI::SetVelV(double x, int point){
...
double RemeshMPI::GetOneVelU(int takeVel){
...
double RemeshMPI::GetOneVelV(int takeVel){
...
void RemeshMPI::SetAdaptDrop(double r){

  g = r;

}

void RemeshMPI::SetRK(int i){
...
void RemeshMPI::SetOptionCluster(int i){
...
void RemeshMPI::SetOptionDistribution(int i){
...
void RemeshMPI::SetTuneDistributionAdaptivity(double adapt){
...
void RemeshMPI::RemeshDistribution(GeometryMPI* GeoHere, double *xOut, double *yOut){

  PetscMPIInt rank;
  MPI_Comm_rank(PETSC_COMM_WORLD,&rank);

  if (rank==0) {
  printf("Remesh globally using distribution \n");
  }
...
void RemeshMPI::PassiveMeshStabilization(GeometryMPI* GeoHere, double* u){
...
double RemeshMPI::computeF(double *x, double *y, double *G, double *u, double K, int elem){
